...
| Tenancy: Context         | `.context/tenancy/context.md`                             | `getTenantContext` / `runAsOrg` / `runAsSystem` / `forEachOrg`, the guards' read rule, the `x-sunrise-org` resolver seam, the policy arm       |
