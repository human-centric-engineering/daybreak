...
const ALLOWED_CALL_SITES: readonly string[] = [
  ...
  // into `agentId` is exactly the #599/#600 bug — omitted instead.
  //
  ...
  'lib/framework/facilitation/evaluation/supervise.ts | agentId=— | conversationId=conversationId | workflowExecutionId=—',
