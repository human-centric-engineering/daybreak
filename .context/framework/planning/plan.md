...
| Lead                    | Simon Holmes                                                                                                                                                                                                                                                                                                    |
| Status                  | `in flight` — `f-seams` + `f-bootstrap` + `f-module-core` + `f-map` + `f-slots` + `f-journey-state` + `f-engine` + `f-slot-capture` + `f-module-bindings` + `f-module-config` **shipped**; `f-guidance` (John) **in flight**; **3 features available to claim** (`f-engagement`, `f-map-editor`, `f-ops-views`) |
