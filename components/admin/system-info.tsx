      ...
      <CardContent>
        {stats?.system ? (
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
            ...
            */}
            {/*
              DAYBREAK — the framework row, between the app above it and the
              platform below it, so the card reads top-down through the three
              tiers. Labelled "Daybreak framework" for the same reason the row
              below says "Sunrise platform": in unrebranded Daybreak `BRAND.name`
              IS "Daybreak", and a bare label would collide with the app row.
            */}
            <InfoItem label="Daybreak framework" value={stats.system.daybreakVersion} />
